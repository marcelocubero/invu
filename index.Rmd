...
filtrarRegistros <-  reactive({
  cuadrantes_f <-
   cuadrantes %>%
  dplyr::select(aprob, canton, distrito)
...
![](https://marcelocubero.github.io/capas_TFG/5.png){width='500px'} 
![](https://marcelocubero.github.io/capas_TFG/INVU.jpg){width='500px'}